                    ...
                    <nav class="menu-header">
                        <ul class="menu-header__list">
                            <li class="menu-header__dropdown _icon-arrow-down">
                                ...
                                <picture><source srcset="img/header/icon-arrow.svg" type="image/webp"><img class="menu-header__icon" src="{{ asset('/img/header/icon-arrow.svg') }}" alt="Icon" data-dropdown></picture>
                                <ul class="_dropdown">
                            ...
                            <li><a class="menu-header__link" href="">Hujjatlar</a></li>
                            <li><a class="menu-header__link" href="">Bog‘lanish</a></li>
                        </ul>
                    </nav>
                </div>
